//jeeTree data structure
//6:52 PM ET 5/15/2017
//Mike Van Maele
//Talus Analytics, LLC
//mvanmaele@talusanalytics.com

// Current version: 051517-B
// Previous version: 051117-B
// Changes since previous version:
// *Merged in additional data for the indicators that are not being costed (their names)
// *Merged in latest expenses data from GU team (updated D.2 Real Time Surveillance)

//All data are notional or drafts.
...
export const jeeTree = [
    ...
    "capacities": [
            ...
            "expenses": [
              {
                ...
                "multiplier_facility": null,
                "multiplier_population": null,
                "cost_type": "startup",
                "parent_indicator": "P.1.1",
                "expense_id": "P.1.1.1",
                "name": "Hire legal advisor",
                "description": "Salary for government legal expert to assess relevant legislation, regulation, administrative requirements and other government instruments for IHR (2005) implementation. Default: 3 months' salary.",
                "sophistication_name": "Salary - Legal Advisor (National)",
              ...
              },
              {
                ...
                "expense_id": "P.1.1.1",
                "name": "Hire legal advisor",
                "description": "Fees for legal consultant to assess relevant legislation, regulation, administrative requirements and other government instruments for IHR (2005) implementation. Default: 56 days' fees at 1,000 $ per day.",
                "sophistication_name": "Fees - Legal Advisor (Consultant)",
                "category": "Human Capabilities",
                "object_class": "Contractual services",
                "cost_unit": "consulting fees per day",
                "cost_duration": 56,
                "cost_duration_unit": "days",
                "multiplier_depreciation": null
              },
              {
                "cost": 4.89,
                ...
                "expense_id": "P.1.1.1",
                "name": "Hire legal advisor",
                "description": "Travel for international legal consultant. Default: 4,890 $ per trip for 4 trips.",
                "sophistication_name": "Travel expenses - Legal Advisor (International)",
                "category": "Human Capabilities",
                "object_class": "Contractual services",
                "cost_unit": "per trip",
                "cost_duration": 4,
                "cost_duration_unit": "trips",
                "multiplier_depreciation": null
              },
              {
                "cost": 100.7,
                ...
                "parent_indicator": "P.1.1",
                "expense_id": "P.1.1.2",
                "name": "Workshop expenses -Legal Review (x 4)",
                "description": "Expenses for stakeholder workshops to review national legal framework, consider proposed revisions, and initiate process of adopting legislation for IHR implementation. Default: 15 people attend 4 1-day conferences with 100.70 $ allowance per day.",
                "sophistication_name": "Workshop expenses -Legal Review (x 4)",
                "category": "Tools and Processes",
                "object_class": "Meeting/Workshop",
                "cost_unit": "national travel or per diem allowance per day",
                "cost_duration": 4,
                "cost_duration_unit": "days",
                "multiplier_depreciation": null
              },
              {
                ...
                "parent_indicator": "P.1.1",
                "expense_id": "P.1.1.3",
                "name": "Printing - Draft national legislation",
                "description": "Printing draft national legislation and workshop notes for stakeholder legal review. Default: 100 total sheets x 15 stakeholders x 4 workshops x 0.15 $ per sheet.",
                "sophistication_name": "Printing - Draft national legislation",
                "category": "Tools and Processes",
      ...
      },
      {
        ...
        "indicators": [
          {
            "jee_id": "P.3.1",
            "name": "Antimicrobial resistance (AMR) detection",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
          ...
          {
            "jee_id": "P.3.2",
            "name": "Surveillance of infections caused by AMR pathogens",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
          ...
          {
            "jee_id": "P.3.3",
            "name": "Healthcare associated infection (HCAI) prevention control programs",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
          ...
          {
            "jee_id": "P.3.4",
            "name": "Antimicrobial stewardship activities",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
      ...
      },
      {
        ...
        "indicators": [
          {
            "jee_id": "P.4.1",
            "name": "Surveillance systems in place for priority zoonotic diseases/pathogens",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
          ...
          {
            "jee_id": "P.4.2",
            "name": "Veterinary or Animal Health Workforce",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
          ...
          {
            "jee_id": "P.4.3",
            "name": "Mechanisms for responding to infectious zoonoses and potential zoonoses are established and functional",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
      ...
      },
      {
        ...
        "indicators": [
          {
            "jee_id": "P.5.1",
            "name": "Mechanisms are established and functioning for detecting and responding to foodborne disease and food contamination. ",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
      ...
      },
      {
        ...
        "indicators": [
          {
            "jee_id": "P.7.1",
            "name": "Vaccine coverage (measles) as part of national program",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
          ...
          {
            "jee_id": "P.7.2",
            "name": "National vaccine access and delivery",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
    ...
    "capacities": [
            ...
            "expenses": [
              {
                ...
                "multiplier_population": null,
                "cost_type": "recurring",
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.1",
                "name": "Salary - National Surveillance Unit Director",
                "description": "Salary for director of dedicated national surveillance unit (annual) - Default: 1 senior public health specialist making $29,860 per year",
                "sophistication_name": "Salary - National Surveillance Unit Director",
                "category": "Human Capabilities",
                "object_class": "Personnel compensation",
                "cost_unit": "salary per year",
                "cost_duration": null,
                "cost_duration_unit": null,
                "multiplier_depreciation": null
              },
              {
                "cost": 21483.36,
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.2",
                "name": "Salary - National Surveillance Unit Epidemiologist",
                "description": "Salaries for trained epidemiologists to aggregate and analyze indicator- and event-based surveillance data at national level - Default: 5 field-trained epidemiologists making $19,892 per year",
                "sophistication_name": "Salary - National Surveillance Unit Epidemiologist",
                "category": "Human Capabilities",
                "object_class": "Personnel compensation",
                "cost_unit": "salary per year",
                "cost_duration": null,
              ...
              },
              {
                ...
                "multiplier_staff": 1,
                "multiplier_area": "level_2",
                "multiplier_facility": null,
                "multiplier_population": null,
                "cost_type": "recurring",
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.3",
                "name": "Salary - Surveillance Officers (Intermediate 1)",
                "description": "Salaries for surveillance officers to collect, aggregate, and analyze indicator- and event-based surveillance data at intermediate 1 level (state/province equivalent).  Default: 1 epidemiologist per Intermediate 1 area making $13,556.13 per year, assuming 35% of regions pilot.",
                "sophistication_name": "Salary - Surveillance Officers (Intermediate 1)",
                "category": "Human Capabilities",
                "object_class": "Personnel compensation",
                "cost_unit": "salary per year",
                "cost_duration": 0.35,
                "cost_duration_unit": "percent rolled out",
                "multiplier_depreciation": null
              },
              {
                "cost": 14640.62,
                ...
                "expense_id": "D.2.1.27",
                "name": "Salary - Surveillance Officers (Intermediate 1)",
                "description": "Salaries for surveillance officers to collect, aggregate, and analyze indicator- and event-based surveillance data at intermediate 1 level (state/province equivalent).  Default: 1 epidemiologist per intermediate 1 area making $13,556.13 per year, assuming 65% of regions need to roll out",
                "sophistication_name": "Salary - Surveillance Officers (Intermediate 1)",
                "category": "Human Capabilities",
                "object_class": "Personnel compensation",
                "cost_unit": "salary per year",
              ...
              },
              {
                ...
                "multiplier_staff": 1,
                "multiplier_area": "level_3",
                "multiplier_facility": null,
                "multiplier_population": null,
                "cost_type": "recurring",
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.4",
                "name": "Salary - Surveillance Officers (Intermediate 2)",
                "description": "Salaries for  surveillance officers to collect and report surveillance data from health facilities at intermediate 2 level (district equivalent). Default: 1 officer per Intermediate 2 area making $8,372.06 per year, assuming 35% of district equivalents pilot.",
                "sophistication_name": "Salary - Surveillance Officers (Intermediate 2)",
                "category": "Human Capabilities",
                "object_class": "Personnel compensation",
                "cost_unit": "salary per year",
                "cost_duration": 0.35,
              ...
              },
              {
                ...
                "expense_id": "D.2.1.28",
                "name": "Salary - Surveillance Officers (Intermediate 2)",
                "description": "Salaries for  surveillance officers to collect and report surveillance data from health facilities at intermediate 2 level (district equivalent). Default: 1 officer per Intermediate 2 area making $8,372.06 per year, assuming 65% of district equivalents need to roll out.",
                "sophistication_name": "Salary - Surveillance Officers (Intermediate 2)",
                "category": "Human Capabilities",
                "object_class": "Personnel compensation",
                "cost_unit": "salary per year",
              ...
              },
              {
                ...
                "multiplier_staff": null,
                "multiplier_area": "level_4",
                "multiplier_facility": null,
                "multiplier_population": null,
                "cost_type": "recurring",
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.29",
                "name": "Compensation - Surveillance Activities (Local)",
                "description": "Stipends or other compensation for local health facility and community health workers to collect and report surveillance data (structured and unstructured). ",
                "sophistication_name": "Compensation - Surveillance Activities (Local)",
                "category": "Human Capabilities",
                "object_class": "Personnel compensation",
                "cost_unit": "salary per year",
                "cost_duration": 0.35,
              ...
              },
              {
                ...
                "expense_id": "D.2.1.37",
                "name": "Compensation - Surveillance Activities (Local)",
                "description": "Stipends or other compensation for local health facility or community health workers to collect and report surveillance data (structured and unstructured).",
                "sophistication_name": "Compensation - Surveillance Activities (Local)",
                "category": "Human Capabilities",
                "object_class": "Personnel compensation",
                "cost_unit": "salary per year",
              ...
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.5",
                "name": "Salary - National Surveillance Training Coordinator",
                "description": "Salary for 1 public health/training specialist to develop materials and coordinate in-service training in national surveillance protocols for public health and clinical personnel at all levels - Default: 1 specialist at 13556.13 per year",
                "sophistication_name": "Salary - National Surveillance Training Coordinator",
                "category": "Human Capabilities",
              ...
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.6",
                "name": "Workshops- National strategic plan for disease surveillance",
                "description": "Workshops for national stakeholders to establish or update national strategic plan for indicator- and event-based surveillance -  Default: 15 people attend 2 1-day conferences with 100.70 $ allowance per day.",
                "sophistication_name": "Workshops- National strategic plan for disease surveillance",
                "category": "Tools and Processes",
                "object_class": "Meeting/Workshop",
                "cost_unit": "per diem per participant",
                "cost_duration": 15,
                "cost_duration_unit": "participants (at national per diem rates)",
                "multiplier_depreciation": null
              },
              {
                "cost": 108.76,
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.7",
                "name": "Workshops - List of priority diseases, conditions, and events",
                "description": "Workshops for national stakeholders to establish or update consensus list of priority notifiable diseases, conditions, and events -   Default: 15 people attend 2 1-day conferences with 100.70 $ allowance per day.",
                "sophistication_name": "Workshops - List of priority diseases, conditions, and events",
                "category": "Tools and Processes",
                "object_class": "Meeting/Workshop",
                "cost_unit": "per diem per participant",
                "cost_duration": 15,
              ...
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.8",
                "name": "Workshops - Guidance for priority diseases",
                "description": "Workshops for national stakeholders to review and approve guidance for detecting, registering, and reporting cases of priority diseases, conditions, and events  Default: 15 people attend 2 1-day conferences with 100.70 $ allowance per day.",
                "sophistication_name": "Workshops - Guidance for priority diseases",
                "category": "Tools and Processes",
                "object_class": "Meeting/Workshop",
                "cost_unit": "per diem per participant",
                "cost_duration": 15,
              ...
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.9",
                "name": "Print - National Strategic Plan for Disease Surveillance",
                "description": "Print national strategic plan for disease surveillance - Default: 60 pages x .05/page x 250 copies",
                "sophistication_name": "Print - National Strategic Plan for Disease Surveillance",
                "category": "Consumable Materials",
                "object_class": "Printing",
                "cost_unit": "per page",
                "cost_duration": 60,
                "cost_duration_unit": "pages",
                "multiplier_depreciation": null
              },
              {
                "cost": 0,
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.10",
                "name": "Electronic dissemination only - National Strategic Plan and Surveillance Guidance",
                "description": "Disseminate national strategic plan and guidance for disease surveillance as electronic copy only",
                "sophistication_name": "Electronic dissemination only - National Strategic Plan and Surveillance Guidance",
                "category": "Tools and Processes",
                "object_class": "Printing",
                "cost_unit": "per page",
                "cost_duration": null,
              ...
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.11",
                "name": "Print - National Surveillance Guidance: Intermediate 1",
                "description": "Print national surveillance guidance, including case definitions and reporting procedures, for public health and clinical staff at intermediate-1 level - Default: 100 pages x 0.05/page x # of intermediate 1 areas",
                "sophistication_name": "Print - National Surveillance Guidance: Intermediate 1",
                "category": "Consumable Materials",
                "object_class": "Printing",
                "cost_unit": "per page",
                "cost_duration": 100,
              ...
              },
              {
                ...
                "multiplier_staff": null,
                "multiplier_area": "level_3",
                "multiplier_facility": 10,
                "multiplier_population": null,
                "cost_type": "recurring",
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.12",
                "name": "Print - National Surveillance Guidance: intermediate 2",
                "description": "Print national surveillance guidance, including SOPs, case definitions, and reporting procedures, for public health and clinical staff at intermediate-2 level - Default: 100 pages x 0.05/page x # of intermediate 2 areas",
                "sophistication_name": "Print - National Surveillance Guidance: intermediate 2",
                "category": "Consumable Materials",
                "object_class": "Printing",
                "cost_unit": "per page",
                "cost_duration": 100,
              ...
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.13",
                "name": "Print - Job aids for health facility- based surveillance and reporting: local (health facilities)",
                "description": "Print abridged national urveillance guidance for local health facility workers - Default: 20 pages x 0.05/page x # of local areas x 5 facilities per area",
                "sophistication_name": "Print - Job aids for health facility- based surveillance and reporting: local (health facilities)",
                "category": "Consumable Materials",
                "object_class": "Printing",
                "cost_unit": "per page",
                "cost_duration": 20,
              ...
              },
              {
                ...
                "multiplier_staff": "national_chw_count",
                "multiplier_area": "level_1",
                "multiplier_facility": null,
                "multiplier_population": null,
                "cost_type": "recurring",
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.30",
                "name": "Print - Job aids for community-based surveillance and reporting",
                "description": "Print job aids to support indicator- and event-based survey by community health workers - Default: 20 pages x 0.05/page x # of community health workers",
                "sophistication_name": "Print - Job aids for community-based surveillance and reporting",
                "category": "Consumable Materials",
                "object_class": "Printing",
                "cost_unit": "per page",
                "cost_duration": 20,
              ...
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.14",
                "name": "Print - surveillance training materials",
                "description": "Print training materials (annual, all levels) - Default: 100 pages x 0.05/page x # of intermediate 2 areas x 10 participants per intermediate 2 area ",
                "sophistication_name": "Print - surveillance training materials",
                "category": "Consumable Materials",
                "object_class": "Printing",
                "cost_unit": "per page",
                "cost_duration": 1000,
              ...
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.15",
                "name": "Training - 5-day disease surveillance training (intermediate 1 level)",
                "description": "In-person training in disease surveillance and reporting and data analysis for intermediate level 1 surveillance officers - Default:  1 participant per intermediate-1 area x # of intermediate-1 areas x daily per diem x 5 days, assuming 35% of regions pilot roll out",
                "sophistication_name": "Training - 5-day disease surveillance training (intermediate 1 level)",
                "category": "Human Capabilities",
                "object_class": "Training",
                "cost_unit": "per diem per participant (5 days)",
                "cost_duration": 0.35,
                "cost_duration_unit": "percent rolled out",
                "multiplier_depreciation": null
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.31",
                "name": "Training - 5-day disease surveillance training (intermediate 1 leve)",
                "description": "IIn-person training in disease surveillance and reporting and data analysis for intermediate level 1 surveillance officers - Default:  1 participant per intermediate-1 area x # of intermediate-1 areas x daily per diem x 5 days, assuming 65% of regions remain to roll out",
                "sophistication_name": "Training - 5-day disease surveillance training (intermediate 1 leve)",
                "category": "Human Capabilities",
                "object_class": "Training",
                "cost_unit": "per diem per participant (5 days)",
                "cost_duration": 0.65,
              ...
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.16",
                "name": "Training - 5-day disease surveillance training (intermediate 2 level)",
                "description": "In-person training in disease surveillance and reporting and data analysis at intermediate level 2 - Default:  1 participant per intermediate-2 area x # of intermediate-1 areas x daily per diem x 5 days, assuming 35% of intermediate 2 areas roll out",
                "sophistication_name": "Training - 5-day disease surveillance training (intermediate 2 level)",
                "category": "Human Capabilities",
                "object_class": "Training",
                "cost_unit": "per diem per participant (5 days)",
                "cost_duration": 0.35,
              ...
              },
              {
                ...
                "expense_id": "D.2.1.32",
                "name": "Training - 5-day disease surveillance training (intermediate 2 level)",
                "description": "In-person training in disease surveillance and reporting and data analysis at intermediate level 2 - Default:  1 participant per intermediate-2 area x # of intermediate-1 areas x daily per diem x 5 days, assuming 65% of intermediate 2 areas remain to roll out",
                "sophistication_name": "Training - 5-day disease surveillance training (intermediate 2 level)",
                "category": "Human Capabilities",
                "object_class": "Training",
                "cost_unit": "per diem per participant (5 days)",
              ...
              },
              {
                ...
                "multiplier_staff": null,
                "multiplier_area": "level_1",
                "multiplier_facility": "national_count",
                "multiplier_population": null,
                "cost_type": "recurring",
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.17",
                "name": "Training - 3-day surveillance training at health facility level (local)",
                "description": "In-service training  - Default: 1 trainer x daily per diem x 3 days and $15/trainee for incidentals x 3 trainees per facility x # of health facilities, assuming health facilities in 35% of intermediate areas roll out",
                "sophistication_name": "Training - 3-day surveillance training at health facility level (local)",
                "category": "Human Capabilities",
                "object_class": "Training",
                "cost_unit": "per diem per trainer + per person incidental meeting costs (3 days)",
                "cost_duration": 0.35,
                "cost_duration_unit": "percent rolled out",
                "multiplier_depreciation": null
              },
              {
                ...
                "expense_id": "D.2.1.33",
                "name": "Training - 3-day surveillance training at health facility level (local)",
                "description": "In-service training  - Default: 1 trainer x daily per diem x 3 days and $15/trainee for incidentals x 3 trainees per facility x # of health facilities, assuming health facilities in 65% of intermediate areas remain to roll out",
                "sophistication_name": "Training - 3-day surveillance training at health facility level (local)",
                "category": "Human Capabilities",
                "object_class": "Training",
                "cost_unit": "per diem per trainer + per person incidental meeting costs (3 days)",
              ...
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.38",
                "name": "Training - 1-day community-based surveillance training (local)",
                "description": "1 day training for community health workers and health facility focal points in community-based surveillance- Default: 1 trainer x daily per diem x 1 day and $15/trainee for incidentals x 10 trainees per local area per year",
                "sophistication_name": "Training - 1-day community-based surveillance training (local)",
                "category": "Human Capabilities",
                "object_class": "Training",
                "cost_unit": "per diem per trainer + per person incidental meeting costs (1 day)",
                "cost_duration": null,
                "cost_duration_unit": null,
                "multiplier_depreciation": null
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.39",
                "name": "Supervisory visits and data audits - health facility level",
                "description": "2-day annual supervisory visit to monitor implementation and performance of surveillance activities at health facility level - Default: 1 surveillance officer (from national or intermediate 1 level) x daily per diem x 2 days x # local areas",
                "sophistication_name": "Supervisory visits and data audits - health facility level",
                "category": "Human Capabilities",
                "object_class": "Training",
                "cost_unit": "per diem per supervisor",
                "cost_duration": null,
                "cost_duration_unit": null,
                "multiplier_depreciation": null
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.18",
                "name": "Hardware - electronic disease surveillance data management system",
                "description": "Hardware/operating system bundle (data server, storage, controller, and SQL server operating system or equivalent)",
                "sophistication_name": "Hardware - electronic disease surveillance data management system",
                "category": "Technology",
                "object_class": "Information and communications technologies",
                "cost_unit": "Each",
                "cost_duration": null,
                "cost_duration_unit": null,
                "multiplier_depreciation": null
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.34",
                "name": "Maintenance - data server for electronic disease surveillance collection",
                "description": "Annual management contract for server maintenance and updates",
                "sophistication_name": "Maintenance - data server for electronic disease surveillance collection",
                "category": "Technology",
                "object_class": "Contractual services",
                "cost_unit": "Per year",
                "cost_duration": null,
              ...
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.19",
                "name": "Hardware - voltage stabilizer",
                "description": "Voltage stabilizer/uninterruptible power supply",
                "sophistication_name": "Hardware - voltage stabilizer",
                "category": "Technology",
                "object_class": "Information and communications technologies",
                "cost_unit": "Each",
                "cost_duration": null,
              ...
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.20",
                "name": "Hardware - computers for national surveillance unit staff",
                "description": "Desktop or laptop computers, basic software licenses, and peripherals for data analysis and reporting",
                "sophistication_name": "Hardware - computers for national surveillance unit staff",
                "category": "Technology",
                "object_class": "Information and communications technologies",
                "cost_unit": "Each",
                "cost_duration": 6,
                "cost_duration_unit": "Computers",
                "multiplier_depreciation": null
              },
              {
                "cost": 100,
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.21",
                "name": "Communications - mobile phones",
                "description": "Mobile phone handsets (smartphones) for national surveillance unit staff",
                "sophistication_name": "Communications - mobile phones",
                "category": "Technology",
                "object_class": "Information and communications technologies",
                "cost_unit": "Each",
                "cost_duration": 6,
                "cost_duration_unit": "Mobile phones",
                "multiplier_depreciation": null
              },
              {
                "cost": 46.35,
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.22",
                "name": "Communications - telephone (set)",
                "description": "Landline telephone (base and handset) for surveillance unit",
                "sophistication_name": "Communications - telephone (set)",
                "category": "Technology",
                "object_class": "Information and communications technologies",
                "cost_unit": "Each",
                "cost_duration": null,
              ...
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.23",
                "name": "Communications - telephone (usage)",
                "description": "Telephone line usage/rental - default: 10 calls per day * 24 working days per month at $0.2 per three minute local call",
                "sophistication_name": "Communications - telephone (usage)",
                "category": "Technology",
                "object_class": "Information and communications technologies",
                "cost_unit": "call costs per month",
                "cost_duration": null,
                "cost_duration_unit": null,
                "multiplier_depreciation": null
              },
              {
                ...
                "description": "Fax and supplies for surveillance unit",
                "sophistication_name": "Communications - fax",
                "category": "Technology",
                "object_class": "Information and communications technologies",
                "cost_unit": "Each",
                "cost_duration": null,
              ...
              },
              {
                ...
                "description": "Printer/copier for surveillance unit",
                "sophistication_name": "Hardware - printer",
                "category": "Technology",
                "object_class": "Information and communications technologies",
                "cost_unit": "Each",
                "cost_duration": 2,
                "cost_duration_unit": "Printers",
                "multiplier_depreciation": null
              },
              {
                "cost": 17280,
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.35",
                "name": "Software - geographic information system",
                "description": "GIS/visualization software (license) for electronic disease surveillance and analysis system",
                "sophistication_name": "Software - geographic information system",
                "category": "Technology",
                "object_class": "Information and communications technologies",
                "cost_unit": "Per year",
                "cost_duration": null,
              ...
              },
              {
                ...
                "parent_indicator": "D.2.1",
                "expense_id": "D.2.1.26",
                "name": "Surveillance Data Header-A",
                "description": "Hardware/operating system bundle (data server, storage, controller, and SQL server operating system or equivalent)",
                "sophistication_name": "Hardware - electronic disease surveillance data management system",
                "category": "Technology",
                "object_class": "Information and communications technologies",
      ...
      },
      {
        ...
        "indicators": [
          {
            "jee_id": "D.4.1",
            "name": "Human resources are available to implement IHR core capacity requirements",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
          ...
          {
            "jee_id": "D.4.2",
            "name": "Applied epidemiology training program in place such as FETP",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
  ...
  },
  {
    ...
    "capacities": [
      ...
      {
        "name": "Medical Countermeasures and Personnel Deployment",
        "type": "",
        "target_description": "",
        "as_measured_by": "",
        "desired_impact": "",
        ...
        "indicators": [
          {
            "jee_id": "R.4.1",
            "name": "System is in place for sending and receiving medical countermeasures during a public health emergency",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
          ...
          {
            "jee_id": "R.4.2",
            "name": "System is in place for sending and receiving health personnel during a public health emergency",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
      ...
      },
      {
        ...
        "indicators": [
          {
            "jee_id": "R.5.1",
            "name": "Risk Communication Systems (plans,mechanisms, etc.)",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
          ...
          {
            "jee_id": "R.5.2",
            "name": "Internal and Partner Communication and Coordination",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
          ...
          {
            "jee_id": "R.5.4",
            "name": "Communication Engagement with Aﬀected Communities",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
          ...
          {
            "jee_id": "R.5.5",
            "name": "Dynamic Listening and Rumour Management",
            "type": "indicator",
            "questions": [],
            "expenses": [],
            "score_descriptions": {
